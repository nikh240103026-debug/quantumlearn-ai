...
print(qc)`,
    hint: "QuantumCircuit(1) creates a circuit with one qubit.",
    expected: "Circuit created with 1 qubit.",
  },
  {
    id: "apply-x",
...
print(qc)`,
    hint: "The Qiskit method for the Pauli-X gate is x().",
...
print(qc)`,
    hint: "The Hadamard gate is represented by h() in Qiskit.",
...
print(qc)`,
    hint: "CNOT is represented by cx(control, target).",
    expected: "Bell state circuit created successfully.",
  },
  {
    id: "measurement",
...
print(qc)`,
    hint: "Qiskit's measurement method is measure(qubit, classical_bit).",
    expected: "Measurement operation added successfully.",
  },
];
...
export default function CodingChallenges() {
  ...
  function selectChallenge(challenge: Challenge) {
    ...
    setOutput("Run your solution to check the challenge.");
    setShowHint(false);
  }
  ...
  function runChallenge() {
    const normalizedUser = code.replace(/\s/g, "");
    const normalizedSolution = selected.solution.replace(/\s/g, "");
    ...
    setOutput(
      "✗ Challenge not completed.\n\nYour code does not match the required solution yet.\n\nUse the hint if you need help."
    );
  }
          ...
          <main className="min-w-0 bg-[#050b14]">
              ...
              <div className="mt-3 flex flex-wrap items-start justify-between gap-4">
                ...
                <div
                  className={`border px-3 py-2 text-[10px] font-bold uppercase tracking-wider ${
                    difficultyStyle[selected.difficulty]
                  }`}
                >
                  {selected.difficulty}
                </div>
            ...
            <div className="grid gap-px bg-slate-800 lg:grid-cols-[minmax(0,1fr)_310px]">
              ...
              <section className="flex min-h-[650px] flex-col bg-[#03070d]">
                ...
                <div className="flex min-h-0 flex-1">
                  ...
                  <textarea
                    ...
                    spellCheck={false}
                    className="min-h-[470px] flex-1 resize-none overflow-auto bg-transparent p-4 font-mono text-xs leading-6 text-slate-300 outline-none"
                  />
                </div>
                ...
                <div className="border-t border-slate-800">
                  ...
                  <pre
                    className={`min-h-[130px] whitespace-pre-wrap p-4 font-mono text-[11px] leading-5 ${
                      output.startsWith("✓")
                        ? "text-emerald-400"
                        : output.startsWith("✗")
                          ? "text-red-400"
              ...
              <aside className="bg-[#07101d]">
                <div className="border-b border-slate-800 px-5 py-4">
                  <div className="flex items-center gap-2">
                    <CircleHelp size={15} className="text-blue-400" />
            ...
            <div className="flex items-center justify-between border-t border-slate-800 bg-[#07101d] px-5 py-4 sm:px-8">
              <div className="text-[10px] uppercase tracking-wider text-slate-700">
                {completed.length} of {challenges.length} completed
              </div>
              ...
              <button
                ...
                onClick={() => {
                  const currentIndex = challenges.findIndex(
                    (challenge) => challenge.id === selected.id
                  );
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-300">
                    {completed.length} / {challenges.length} challenges
                  </p>
                </div>
